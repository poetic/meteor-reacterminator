...
const reacterminator = require('../../reacterminator/lib/index');
const { exec, mkdir, rm, cp, test } = require('./helpers/shelljs');
...
module.exports = function update() {
  ...
  logTask('Check is custom directory exists, if not create it.');
  if (!test('-d', 'client/imports/custom')) {
    mkdir('-p', 'client/imports/custom');
  }
